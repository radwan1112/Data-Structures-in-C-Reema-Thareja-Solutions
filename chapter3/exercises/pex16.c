...
int sum_above_diagonal(int *matrix, int rows, int cols)
{
    int i, j;
    int sum = 0;
...
int main()
{
    ...
    printf("-- Sum of Elements above the main diagonal of a matrix  --\n\n");
    int size;
    ...
    int sum = sum_above_diagonal(matrix, size, size);
