...
struct node *merge_lists(struct node *start, struct node *start2)
{
    struct node *ptr;
    ptr = start;
    start2;
...
int main()
{
    ...
    do
    {
        ...
        {
        case 1:
            printf("\n Enter the data of the first list: \n");
            start = create_ll(start);
            printf("\n Enter the data of the second list: \n");
            start2 = create_ll(start2);
            printf("\n TWO LINK LIST CREATED");
            break;
        case 2:
            start = display(start);
