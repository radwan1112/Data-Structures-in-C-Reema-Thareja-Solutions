...
struct node *sort_style(struct node *start)
{
    struct node *ptr, *preptr;
    ptr = start;
    preptr = start;
    ...
    if(ascending_order)
    {
        printf("\n The items are sorted in an ascending order");
    }
    else if(descending_order)
    {
        printf("\n The items are sorted in a descending order");
    }
    else
    {
...
int main()
{
    ...
    do
    {
        ...
        printf("\n 12: Sort the list");
        printf("\n 13: Find how the items are sorted");
        printf("\n 14: EXIT");
        printf("\n\n Enter your option: ");
        scanf(" %d", &option);
        switch(option)
