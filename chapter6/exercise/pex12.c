...
struct node *concat_dll(struct node *start, struct node *start2)
{
    struct node *ptr;
    ptr = start;
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            start2 = create_dll(start2);
            printf("\n TWO DOUBLY LINKED LIST CREATED");
            break;
        case 2:
            start = display(start);
            break;
        ...
        case 11:
            ...
            break;
        case 12:
            start = concat_dll(start, start2);
            printf("\n DOUBLY LINKED LIST HAS BEEN CONCATENATED");
            break;
        default:
            option = 13;
            break;
